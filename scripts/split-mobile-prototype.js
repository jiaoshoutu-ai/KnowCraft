/**
 * Split prototypes/mobile.html into standalone page files using cheerio
 *
 * Each output file contains:
 * - Complete <head> with all styles and global scripts
 * - <body> containing only the specific page node
 *
 * Output: ./prototype-fragments-mobile/
 *   - home-screen.html
 *   - login.html
 *   - topic-library.html
 *   - topic-detail.html
...
const SRC = path.join(ROOT, 'prototypes', 'mobile.html');
const OUT = path.join(ROOT, 'prototype-fragments');
